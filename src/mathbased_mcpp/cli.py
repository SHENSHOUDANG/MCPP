...
def main() -> None:
    ...
    if args.command == "doctor":
        ...
        print(f"interop_threads={config.train.interop_threads}")
        print(f"rollout_workers={config.train.rollout_workers}")
        print(f"gpu_memory_fraction={config.train.gpu_memory_fraction}")
        print(f"process_priority={config.train.process_priority}")
